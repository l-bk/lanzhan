 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/cms/recommend")
public class RecommendController extends BaseController {
	...
	@RequiresPermissions("cms:recommend:view")
	...
	public String list(Comment comment, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/cms/recommendList";
	}

	@RequiresPermissions("cms:recommend:edit")
	...
	public String save(Comment comment, RedirectAttributes redirectAttributes) {
		...
		return "redirect:" + adminPath + "/cms/recommend/?repage&delFlag=2";
	}
