	...
	<div class="column-panel">
		<c:forEach items="${page.list}" var="t" varStatus="i" begin="0">
			<div class="w_all backff bor_botcc mtop10">
				<div class="in_listtu">
					<a href="${t.url}"><img src="${t.image}" alt=""></a>
				</div>
				<div class="txtcenter ptop10">
					—— <span class="bor_zj_3bt_e"><a href="${t.url}">YUEDU</a></span><span class="color_red bor_zj_3bt_c"><a href="${t.url}">时尚</a></span>——
				</div>
					...
					.ajax({
						...
						success : function(d) {
							...
							'	alt=""></a>'
															+ '</div>'
															+ '<div class="txtcenter ptop10">'
															+ '	—— <span class="bor_zj_3bt_e"><a href="'+t.url+'">YUEDU</a></span><span class="color_red bor_zj_3bt_c"><a href="'+t.url+'">'
															'时尚</a></span>——' + '</div>' + '<div class="txtcenter in_listwz">'
															+ '	<a href="'+t.url+'">' + t.title + '</a>' + '</div>'
															+ '	<div class="txtcenter in_listdate">' + (t.createDate).substring(5,10) + '</div>' + '</div>';
