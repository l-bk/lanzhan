...
<body>
	<ul class="nav nav-tabs">
		...
		<li>
		<a href="${ctx}/cms/sensitive/">
		敏感词列表		</a>
		</li class="active">
		<li><a href="${ctx}/cms/sensitive/form">
		敏感词添加
		</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sensitive" action="${ctx}/cms/sensitive/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="value" htmlEscape="false" maxlength="200" class="input-xlarge required" data-act="innum" data-target="#keywordsNum" data-length="25"/> 
