...
<body>
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="cmsEDITMainFrame" name="cmsEDITMainFrame" src="${ctx}/cms/template/help" style="overflow:visible;"
				scrolling="yes" frameborder="no" width="100%"></iframe>
		</div>
	</div>
	<script type="text/javascript"> 
		...
		function wSize(){
			...
			$("#cmsMenuFrame, #cmsEDITMainFrame, #openClose").height(strs[0]-5);
