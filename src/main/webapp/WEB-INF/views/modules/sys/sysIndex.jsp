...
<head>
    ...
    <link href="${ctxStatic}/common.css" type="text/css" rel="stylesheet"/>
</head>
<body>
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<!-- <li><a href="${pageContext.request.contextPath}${fns:getFrontPath()}/index-${fnc:getCurrentSiteId()}.shtml" target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li>
