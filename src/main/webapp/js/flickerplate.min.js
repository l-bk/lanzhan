...
function(a) {
	var b = function() {
			...
			b.settings = {
				...
				if (void 0 != l && 0 == l && (b.settings.block_text = !1), d.find("ul.flicks a > li").each(function() {
				...
				for ($dot_nav_html = '<div class="dot-navigation ' + c + '"><ul>'; e > f;) f++, $dot_nav_html += 1 == f ? '<li style="width:'+ 100 / e+'%"><div class="dot active"></div></li>' : '<li style="width:'+ 100 / e+'%"><div class="dot"></div></li>';
